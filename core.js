...
const ParanLabCore = {
    ...
    scenariosList: [
        ...
        { id: "shopping", title: "합리적 소비", icon: "💰", href: "/scenarios/shopping/" },
        { id: "burnout", title: "번아웃 탈출", icon: "📅", href: "/scenarios/burnout/" },
        { id: "goal", title: "목표 달성", icon: "📍", href: "/scenarios/goal/" },
        { id: "problem", title: "문제 해결", icon: "❓", href: "/scenarios/problem/" },
        { id: "creative", title: "창의적 기획", icon: "💡", href: "/scenarios/creative/" },
        { id: "purpose", title: "삶의 목적", icon: "🌸", href: "/scenarios/purpose/" },
        { id: "risk", title: "리스크 관리", icon: "🌳", href: "/scenarios/risk/" },
        { id: "team", title: "조직 소통", icon: "🪟", href: "/scenarios/team/" }
    ],
    ...
    layout: {
        header: function(tools, isAutoSaveOn) {
            ...
            return `
                <div class="w-full bg-slate-50 border-b border-slate-100 no-print overflow-hidden" style="height: 60px;">
                    <ins class="adsbygoogle" style="display:inline-block;width:100%;height:60px" data-ad-client="ca-pub-6902579674102145" data-ad-slot="auto"></ins>
                    <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
                </div>
                <header class="border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-[9999] no-print">
        ...
        footer: function(familySites) {
            ...
            return `
                <footer class="max-w-6xl mx-auto px-6 py-16 mt-12 border-t border-slate-100 text-center no-print">
                    <div class="mb-12 w-full overflow-hidden rounded-2xl" style="min-height: 100px;">
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-6902579674102145" data-ad-slot="auto" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
                    </div>
